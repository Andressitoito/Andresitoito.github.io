...
\usepackage[left=0.7in,top=0.3in,right=0.7in,bottom=0.16in]{geometry} % Document margins
\usepackage{hyperref}
...
\begin{itemize}
  ...
  \item \textbf{Address:} Caballito, City of Buenos Aires, Argentina
\end{itemize}
...
\begin{multicols}{2}
    ...
    \section*{\textsc{\underline{Technical strengths}}}
      ...
      \begin{itemize}
        ...
        \item \textbf{Backend Development:} RESTful APIs, NestJs, Authentication and Authorization (JWT, OAuth), Middleware, Testing, WebSockets\\
    ...
    \begin{itemize}
      \setlength\itemsep{-15px}
      \item \textbf{BackEnd Developer Training}\\\textcolor{light-gray}{Coderhouse}
    \end{itemize}
